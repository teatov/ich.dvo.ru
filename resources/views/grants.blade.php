<x-app-layout>
    ...
    <section class="">
        ...
        <hr>
        <div class="flex items-center gap-2 justify-end mt-4 mb-8">
            <div class="relative inline-block text-[#666]">
                <select class="appearance-none bg-white border rounded pr-24 py-2 pl-5">
            ...
            <div class="relative inline-block text-[#666]">
            <select class="appearance-none bg-white border rounded pr-12 py-2 pl-5">
