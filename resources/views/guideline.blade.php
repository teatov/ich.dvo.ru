<x-app-layout container="">
    ...
    <section class="mb-16 bg-[#767676] pb-15 pt-32 text-[#fff]">
        <div class="container px-4 md:px-0">
            <div class="max-w-[800px]">
                ...
                <x-h1 class="mb-5 text-start font-semibold text-[#fff]">Название тематики</x-h1>
                <p class="mb-7 text-2xl md:text-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                    eiusmod tempor
    ...
    <!-- Вторая секция -->
    <section class="container mb-20 flex flex-col items-center gap-8 px-4 md:flex-row md:px-0">
        <div class="max-w-3xl">
            <x-h2 class="mb-5 text-2xl font-semibold md:text-3xl">Lorem ipsum dolor sit amet, consectetur adipiscing
                elit</x-h2>
            <x-p class="mb-8 text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                ...
                elit,
                sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim </x-p>
            <div>
        ...
        <div class="w-full md:w-auto">
            <x-img class="h-auto rounded md:max-w-[420px]"
                        ...
                        <li>
                            ...
                            <div class="flex gap-x-3 py-12">
                                ...
                                <div>
                                    ...
                                    <x-p class="mt-0 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                                        sed do eiusmod tempor incididunt ut labore et dolore </x-p>
                                </div>
                            </div>
                        </li>
                    @endfor
